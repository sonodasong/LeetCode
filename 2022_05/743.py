    ...
    def networkDelayTime(self, times: List[List[int]], n: int, k: int) -> int:
        ...
        while q.qsize() > 0:
            ...
            for v, t in d[u]:
                if c[v]: continue
                t += w
                if r[v] is None or t < r[v]:
                    r[v] = t
                    q.put((r[v], v))
        r = r[1:]
        return -1 if None in r else max(r)
